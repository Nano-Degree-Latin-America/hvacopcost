...
class IdasAjustadosCoordinacion extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('idas_ajustados_coordinacion', function (Blueprint $table) {
            $table->id();
    ...
    {
            Schema::dropIfExists('idas_ajustados_coordinacion');
    }
}
