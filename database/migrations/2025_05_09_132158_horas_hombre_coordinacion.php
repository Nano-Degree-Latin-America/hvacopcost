...
class HorasHombreCoordinacion extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('horas_hombre_coordinacion', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('horas_hombre_coordinacion');
    }
}
