...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::get('Recupera tu Contraseña'))
            ...
            ->line(Lang::get('Este enlace de restablecimiento de contraseña caducará en 15 :count minutos.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.')]))
