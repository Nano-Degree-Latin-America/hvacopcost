<div id="content" style=" display: flex; justify-content: center;" class="font-roboto">
    <div style="width: 100%; text-align: -webkit-right;" class="mx-1">
        <div style="background-color: #0D08EE;" class="text-white rounded-t-xl w-80 2xl:flex xl:flex lg:grid justify-between 2xl:py-3 xl:py-3 lg:py-0 ">
            <div class="ml-5 2xl:w-10 xl:w-auto lg:w-1/4 flex justify-start">
             <a href="#final1">   <button onclick="active_display_Edit('sol_1');" type="button" style="background-color: #0D08EE;" class="rounded-xl p-1 m-0 hover-button-plus text-3xl"><i class="fa-solid fa-plus text-white"></i></button></a>
            ...
            <div class="2xl:ml-5 xl:ml-5 lg:ml-10 w-full flex 2xl:justify-center xl:justify-center lg:justify-center py-1">
                <h2 style="" class="text-white font-bold text-3xl">{{ __('index.solucion') }} A</h2>
            </div>
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                            ...
                            $(document).ready(function () {
                                ...
                                ,'capacidad_total','costo_elec','csStd_cant_1_1','cheValorS_1_1','','','csStd','maintenance_cost_1_1','marca_1_1','modelo_1_1','ventilacion_1_1','filtracion_1_1','tipo_ambiente_1_1','proteccion_condensador_1_1','proteccion_condensador_1_1_value','unidad_capacidad_tot');
                                }
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="w-full flex justify-start">
                        <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2" onchange="change_diseño(this.value,1,'csDisenio_1_1','tipo_control_1_1','dr_1_1','ventilacion_1_1','filtracion_1_1','lblCsTipo_1_1');"  name="csTipo" id="csTipo">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-1/2 justify-start gap-x-2">
                        <div class="w-full">
                            <input type="text" {{-- value="{{$unidad_hvac_val->capacidad_tot}}" --}} onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-2 text-center" name="capacidad_total" id="capacidad_total" >
                        </div>
                        <div class="w-full">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-full justify-start gap-x-2">
                        <div class="flex justify-start w-1/3">
                            <select name="csStd" id="csStd" style="font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_1_1').value,'csStd');" style="padding-top: 0.68rem;padding-bottom: 0.68rem;"{{--  onchange="set_ser_to_sers(this.value);" --}} class="w-full border-2 border-color-inps rounded-md text-center">

                            </select>
                        </div>
                        <div class="flex justify-start w-1/3">
                            <input name="csStd_cant_1_1" id="csStd_cant_1_1" {{-- value="{{number_format($unidad_hvac_val->eficencia_ene_cant)}}" --}} type="text" class="text-center w-full border-2 border-color-inps rounded-md">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <input id="costo_elec" name="costo_elec"{{--  value="${{$unidad_hvac_val->costo_elec}}" --}} onchange="asign_cos_ele(this.value);" onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full text-center border-2 border-color-inps rounded-md py-1">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    <div class="flex justify-start w-1/3 text-left">
                        <label style="font-size: 14px;" class="text-left" for=""><b>{{ __('index.hors enf') }}</b> </label>
                    </div>
                    <div class="flex justify-start w-1/3">
                        <input type="text" style="font-size: 14px;" onchange="hrs_enfs_inps(this.value);format_nums_no_$(this.value,this.id);"onkeypress="return soloNumeros(event)" class="w-full border-2 border-color-inps rounded-md py-1 text-center" name="hrsEnfriado" id="hrsEnfriado" >
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select onchange="send_name(this.id);check_sin_doa(this.id,'ventilacion_1_1','filtracion_1_1','csTipo');" name="csDisenio_1_1" id="csDisenio_1_1" class="w-full border-2 border-color-inps rounded-md py-2">
                        </select>
                    </div>
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex justify-start w-full">
                        <select class="w-full border-2 border-color-inps rounded-md py-1"   onchange="send_name_t_c(this.id);" name="tipo_control_1_1" id="tipo_control_1_1">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="w-full flex justify-start">
                        <select style="width: 77%;margin-left:1.5px;" class="border-2 border-color-inps rounded-md py-1" onchange="send_name_dr(this.id);" name="dr_1_1" id="dr_1_1" >
                        </select>
                    </div>
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_1_1','cUnidad_1_1','csTipo');"  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_1_1" id="ventilacion_1_1">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);send_name_filt(this.id);"  style="width: 77%;margin-left:0px;padding-top: 0.63rem;padding-bottom: 0.63rem;" class="border-2 border-color-inps rounded-md " name="filtracion_1_1" id="filtracion_1_1">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_1_1','new',3,'paises_edit');send_ambiente(this.value,'new');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_1_1" id="tipo_ambiente_1_1">
                            <option selected value="0">{{ __('index.seleccionar') }}</option>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                    <div class="w-1/3 flex justify-start text-left">
                        <label style="" class="labels" for=""><b>{{ __('index.inversion inicial') }} (CAPEX)</b> </label>
                    </div>

                    <div class="w-1/2 flex justify-start text-left">
                        <input onchange="format_num(this.value,this.id);" {{-- value="${{number_format($unidad_hvac_val->val_aprox)}}" --}} type="text" class="2xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center"  step="0.01" name="cheValorS_1_1" id="cheValorS_1_1" >
     ...
     <div class="grid w-full hidden mt-2"  id="sol_1_2" name="sol_1_2">
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                            ...
                            $(document).ready(function () {
                                ...
                                ,'costo_elec_1_2','csStd_cant_1_2','cheValorS_1_2','sol_1_2','action_submit_1_2','csStd_1_2','maintenance_cost_1_2','marca_1_2','modelo_1_2','ventilacion_1_2','filtracion_1_2','tipo_ambiente_1_2','proteccion_condensador_1_2','proteccion_condensador_1_2_value','_');
                                            }
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="w-full flex justify-start">
                        <select style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-2" onchange="change_diseño(this.value,2,'csDisenio_1_2','tipo_control_1_2','dr_1_2','ventilacion_1_2','filtracion_1_2','lblCsTipo_1_2');"  name="csTipo_1_2" id="csTipo_1_2">
                        </select>
                    </div>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select name="marca_1_2" id="marca_1_2" class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_modelos(this.value,'modelo_1_2');">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-1/2 justify-start gap-x-2">
                        <div class="w-full">
                            <input name="capacidad_total_1_2" id="capacidad_total_1_2"   onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-2 text-center" >
                        </div>
                        <input  id="capacidad_total_1_2_count" name="capacidad_total_1_2_count" type="number" class="hidden" value="1">

                        <div class="w-full">
                            <input class="w-full  border-2 border-color-inps rounded-md h-full text-center"  type="text" readonly name="unidad_capacidad_tot_1_2" id="unidad_capacidad_tot_1_2" >
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-full justify-start gap-x-2">
                        <div class="flex justify-start w-1/3">
                            <select name="csStd_1_2" id="csStd_1_2" style="font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_1_2').value,'csStd_1_2');" style="padding-top: 0.3rem;padding-bottom: 0.3rem;"{{--  onchange="set_ser_to_sers(this.value);" --}} class="w-full border-2 border-color-inps rounded-md text-center">

                            </select>
                         </div>

                        <div class="flex justify-start w-1/3">
                            <input id="csStd_cant_1_2" name="csStd_cant_1_2" type="number"  step="0.5" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center">
                        </div>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <input id="costo_elec_1_2" name="costo_elec_1_2"  readonly onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center">
                     </div>
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex justify-start w-1/3">
                        <input type="text" style="font-size: 14px;" readonly class="w-full border-2 border-color-inps rounded-md py-1 text-center" name="hrsEnfriado_1_2" id="hrsEnfriado_1_2">
            ...
            <div class="flex w-full 2xl:mt-4 xl:mt-4 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select class="w-full border-2 border-color-inps rounded-md py-2"  onchange="send_name(this.id);check_sin_doa(this.id,'ventilacion_1_2','filtracion_1_2','csTipo_1_2');" name="csDisenio_1_2" id="csDisenio_1_2">
                        </select>
                    </div>
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex justify-start w-full">
                        <select class="w-full border-2 border-color-inps rounded-md py-1"  onchange="send_name_t_c(this.id);"  name="tipo_control_1_2" id="tipo_control_1_2">
                        </select>
                    </div>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <select style="width: 75%;margin-left:3.5px;" class="border-2 border-color-inps rounded-md py-1"  onchange="send_name_dr(this.id);" name="dr_1_2" id="dr_1_2" >
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select class="w-full border-2 border-color-inps rounded-md py-2" name="csMantenimiento_1_2" id="csMantenimiento_1_2">
                            <option selected value="0">{{ __('index.seleccionar') }}</option>
                            <option value="ASHRAE 180">ASHRAE 180</option>
                            <option value="Deficiente">Deficiente</option>
                            <option value="Sin Mantenimiento">Sin Mantenimiento</option>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_1_2','new',3,'paises_edit');"  style="width: 77%;margin-left:0px;" readonly class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_1_2" id="tipo_ambiente_1_2">
                            <option selected value="0">{{ __('index.seleccionar') }}</option>
                            <option value="no_agresivo">No Agresivo</option>
                            <option value="marino">Marino</option>
                            <option value="contaminado">Contaminado</option>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                         <input onchange="format_num(this.value,this.id);"  class="w-full border-2 border-color-inps rounded-md py-1 text-center"  step="0.01" name="cheValorS_1_2" id="cheValorS_1_2" >
                ...
                <div class="grid gap-y-2 my-2">
                    <div class="flex w-full">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                           ...
                           <div class="w-1/2 flex justify-start">
                               <select class="w-full border-2 border-color-inps rounded-md p-2" onchange="unidadHvac(this.value,3,'csTipo_1_3','{{App::getLocale()}}');check_chiller(this.value,'csStd_1_2',1)" name="cUnidad_1_3" id="cUnidad_1_3" >
                                    <option selected value="0">{{ __('index.seleccionar') }}</option>
                                   <option value="1">Paquetes (RTU)</option>
                                   <option value="2">Split DX</option>
                                   <option value="3">VRF No Ductados</option>
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                           ...
                           <div class="w-full flex justify-start">
                            <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2"  onchange="change_diseño(this.value,3,'csDisenio_1_3','tipo_control_1_3','dr_1_3','lblCsTipo_1_3');"   name="csTipo_1_3" id="csTipo_1_3">
                            </select>
                           </div>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                           <div class="w-1/3 flex justify-start text-left">
                               <label style="font-size: 14px;" class="" for=""><b>{{ __('index.tipo diseño') }}</b> </label>
                           </div>
                           <div class="w-1/2 flex justify-start">
                            <select  onchange="send_name(this.id);" class="w-full border-2 border-color-inps rounded-md py-1" name="csDisenio_1_3" id="csDisenio_1_3">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                           ...
                           <div class="flex w-full justify-start gap-x-2">
                               <div class="w-full">
                                   <input type="text" style="font-size: 14px;" onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" class="w-full border-2 border-color-inps rounded-md h-full text-center"  name="capacidad_total_1_3" id="capacidad_total_1_3">
                               </div>
                               <div class="w-full">
                                   <input class="w-full  border-2 border-color-inps rounded-md py-2 text-center"  type="text" readonly name="unidad_capacidad_tot_1_3" id="unidad_capacidad_tot_1_3" >
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                           ...
                           <div class="w-1/2 flex justify-start">
                            <input id="costo_elec_1_3" name="costo_elec_1_3" readonly onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full text-center border-2 border-color-inps rounded-md py-1"><p style="font-size: 12px; margin:0px;"></p>
                           </div>
                        </div>
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                           ...
                           <div class="flex justify-start w-1/3">
                               <input type="text" style="font-size: 14px;" readonly class="w-full border-2 border-color-inps rounded-md py-1 text-center" name="hrsEnfriado_1_3" id="hrsEnfriado_1_3">
                           </div>
                       </div>
                    </div>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                           <div class="flex justify-start w-1/3">
                                <select name="csStd_1_3" id="csStd_1_3" onchange="check_send_efi(this.value,document.getElementById('cUnidad_1_3').value,'csStd_1_3');" style="padding-top: 0.528rem;padding-bottom: 0.528rem;" class="w-full border-2 border-color-inps rounded-md text-center">

                                </select>
                           </div>
                           <div class="flex justify-start w-1/4">
                               <input type="number" id="csStd_cant_1_3" name="csStd_cant_1_3" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center">
                               </div>
                           </div>
                           ...
                           <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                               ...
                               <div class="flex justify-start w-full">
                                <select class="w-full border-2 border-color-inps rounded-md py-1"  onchange="send_name_t_c(this.id);" name="tipo_control_1_3" id="tipo_control_1_3">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                           <div class="w-1/3 flex justify-start text-left">
                               <label class="labels" class="" for=""><b>{{ __('index.dr') }}</b> </label>
                           </div>
                           <div class="w-full flex justify-startw-full flex justify-start text-left">
                            <select style="width: 77%;" class="border-2 border-color-inps rounded-md py-1"  onchange="send_name_dr(this.id);" name="dr_1_3" id="dr_1_3" >
                                <option value="">{{ __('index.seleccionar') }}</option>
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                           <div class="flex w-1/3 justify-start text-left">
                               <label class="labels" class="" for=""><b>{{ __('index.mantenimiento') }}</b> </label>
                           </div>
                           <div class="flex w-full justify-start">
                            <select style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="csMantenimiento_1_3" id="csMantenimiento_1_3">
                               <option selected value="0">{{ __('index.seleccionar') }}</option>
                               <option value="ASHRAE 180">ASHRAE 180</option>
                               <option value="Deficiente">Deficiente</option>
                               <option value="Sin Mantenimiento">Sin Mantenimiento</option>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                           ...
                           <div class="w-1/2 flex justify-start">
                                <input onchange="format_num(this.value,this.id);"  class="2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center" name="cheValorS_1_3" id="cheValorS_1_3" >
                       ...
                       <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-full flex gap-x-2 justify-start">
                            <div class="flex">
                                <input type="text" onchange="format_num(this.value,this.id);" class="2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-2 text-center"  name="maintenance_cost_1_3" id="maintenance_cost_1_3" >
                            </div>
                            <div class="flex justify-end">
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                            ...
                            <option value="10">Chiller - Aire - Tornillo 4 Etapas</option> --}}
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        ,'costo_elec_2_1','csStd_cant_2_1','cheValorS_2_1','2_1','action_submit_2_1','csStd_2_1','maintenance_cost_2_1','marca_2_1','modelo_2_1','ventilacion_2_1','filtracion_2_1','tipo_ambiente_2_1','proteccion_condensador_2_1','proteccion_condensador_2_1_value','_');
                                        }
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="w-full flex justify-start">
                                <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2" onchange="change_diseño(this.value,1,'cheDisenio_2_1','tipo_control_2_1','dr_2_1','ventilacion_2_1','filtracion_2_1','lblCsTipo_2_1','');"  name="cheTipo_2_1" id="cheTipo_2_1">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start gap-x-2">
                                <div class="flex justify-start w-1/3">
                                    <select name="csStd_2_1" id="csStd_2_1" style="font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_2_1').value,'csStd_2_1');" style="padding-top: 0.528rem;padding-bottom: 0.528rem;"{{--  onchange="set_ser_to_sers(this.value);" --}} class="w-full border-2 border-color-inps rounded-md text-center">
                                ...
                                <div class="flex justify-start w-1/3">
                                    <input name="csStd_cant_2_1" id="csStd_cant_2_1"  type="text" style="font-size: 14px;" class="text-center w-full border-2 border-color-inps rounded-md">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                            ...
                            <div class="w-1/2 flex justify-start">
                            <input name="costo_elec_2_1" id="costo_elec_2_1"  readonly onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex justify-start w-1/3">
                                <input type="text" style="font-size: 14px;margin-left:1px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center" name="hrsEnfriado_2_1" id="hrsEnfriado_2_1" readonly>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="send_name(this.id);check_sin_doa(this.id,'ventilacion_2_1','filtracion_2_1','cheTipo_2_1');" name="cheDisenio_2_1" id="cheDisenio_2_1">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex justify-start w-full">
                            <select class="w-full border-2 border-color-inps rounded-md py-1"  onchange="send_name_t_c(this.id);"  name="tipo_control_2_1" id="tipo_control_2_1">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="w-full flex justify-start">
                            <select style="width: 77%;" class="border-2 border-color-inps rounded-md py-1" onchange="send_name_dr(this.id);" name="dr_2_1" id="dr_2_1" >
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_2_1','cUnidad_2_1','cheTipo_2_1');"  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_2_1" id="ventilacion_2_1">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select class="w-full border-2 border-color-inps rounded-md py-2" name="csMantenimiento_2_1" id="csMantenimiento_2_1">
                                    <option value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="ASHRAE 180">ASHRAE 180</option>
                                    <option value="Deficiente">Deficiente</option>
                                    <option value="Sin Mantenimiento">Sin Mantenimiento</option>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_2_1','new',3,'paises_edit');"  style="width: 77%;margin-left:0px;" readonly class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_2_1" id="tipo_ambiente_2_1">
                                    <option selected value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="no_agresivo">No Agresivo</option>
                                    <option value="marino">Marino</option>
                                    <option value="contaminado">Contaminado</option>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                            ...
                            <div class="w-1/2 flex justify-start text-left">
                                <input onchange="format_num(this.value,this.id);"  class="2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center" name="cheValorS_2_1" id="cheValorS_2_1" >
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                            ...
                            <option value="10">Chiller - Aire - Tornillo 4 Etapas</option> --}}
                                <script>
                                $(document).ready(function () {
                                    let type_p_edit_2_2 = '{{$type_p}}'
                                        if(type_p_edit_2_2 == 1 ||  type_p_edit_2_2 == 0){
                                    ...
                                    ,'sol_2_2','action_submit_2_2','csStd_2_2','maintenance_cost_2_2','marca_2_2','modelo_2_2','ventilacion_2_2','filtracion_2_2','tipo_ambiente_2_2','proteccion_condensador_2_2','proteccion_condensador_2_2_value','_');
                                        }
                                });
                                </script>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                        <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2"  onchange="change_diseño(this.value,2,'cheDisenio_2_2','tipo_control_2_2','dr_2_2','ventilacion_2_2','filtracion_2_2','lblCsTipo_2_2');"  name="cheTipo_2_2" id="cheTipo_2_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select name="marca_2_2" id="marca_2_2" class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_modelos(this.value,'modelo_2_2');">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        <div class="flex w-1/3 justify-start text-left">
                            <label class="labels" class="" for=""><b>{{ __('index.capacidad termica') }}</b> </label>
                        </div>
                        <div class="flex w-1/2 justify-start gap-x-2">
                            <div class="w-full">
                                <input style="margin-left: 2.3px;" id="capacidad_total_2_2" name="capacidad_total_2_2"  onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-2 text-center" >
                             </div>
                             <div class="w-full">
                                <input class="w-full border-2 border-color-inps rounded-md h-full text-center"  type="text" readonly name="unidad_capacidad_tot_2_2" id="unidad_capacidad_tot_2_2" >
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex justify-start w-1/4">
                            <select name="csStd_2_2" id="csStd_2_2" style="font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_2_2').value,'csStd_2_2');" style="padding-top: 0.528rem;padding-bottom: 0.528rem;"{{--  onchange="set_ser_to_sers(this.value);" --}} class="w-full border-2 border-color-inps rounded-md text-center">

                            </select>
                        </div>
                        <div class="flex justify-start w-1/4">
                            <input  name="csStd_cant_2_2" id="csStd_cant_2_2" type="text"style="padding-top: 0.425rem;padding-bottom: 0.42rem;"  class="w-full border-2 border-color-inps rounded-md py-1 text-center">
                            <input  id="csStd_cant_2_1_count" name="csStd_cant_2_1_count" type="number" class="hidden" value="1">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                        ...
                        <div class="w-1/2 flex justify-start">
                        <input name="costo_elec_2_2" id="costo_elec_2_2" readonly  onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="text-center w-full border-2 border-color-inps rounded-md py-1">
                            <input  id="costo_elec_2_1_count" name="costo_elec_2_1_count" type="number" class="hidden" value="1">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex justify-start w-1/3">
                            <input type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center" name="hrsEnfriado_2_2" id="hrsEnfriado_2_2" readonly>
                                <input  id="hrsEnfriado_2_1_count" name="hrsEnfriado_2_1_count" type="number" class="hidden" value="1">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md py-2"  onchange="send_name(this.id);check_sin_doa(this.id,'ventilacion_2_2','filtracion_2_2','cheTipo_2_2');" name="cheDisenio_2_2" id="cheDisenio_2_2">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex justify-start w-full">
                            <select class="w-full border-2 border-color-inps rounded-md py-1"  onchange="send_name_t_c(this.id);"  name="tipo_control_2_2" id="tipo_control_2_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                        <select style="width: 77%;" class="border-2 border-color-inps rounded-md py-1"  onchange="send_name_dr(this.id);" name="dr_2_2" id="dr_2_2" >
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_2_2','cUnidad_2_2','cheTipo_2_2');"  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_2_2" id="ventilacion_2_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select style="margin-left: 1px;" class="w-full border-2 border-color-inps rounded-md py-2" name="cheMantenimiento_2_2" id="cheMantenimiento_2_2">
                                <option value="0">{{ __('index.seleccionar') }}</option>
                                <option value="ASHRAE 180">ASHRAE 180</option>
                                <option value="Deficiente">Deficiente</option>
                                <option value="Sin Mantenimiento">Sin Mantenimiento</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_2_2','new',3,'paises_edit');"  style="width: 77%;margin-left:0px;" readonly class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_2_2" id="tipo_ambiente_2_2">
                                <option selected value="0">{{ __('index.seleccionar') }}</option>
                                <option value="no_agresivo">No Agresivo</option>
                                <option value="marino">Marino</option>
                                <option value="contaminado">Contaminado</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                        ...
                        <div class="w-1/2 flex justify-start text-left">
                            <input onchange="format_num(this.value,this.id);"  class="2xl:w-full xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center"   name="cheValorS_2_2" id="cheValorS_2_2" >
              ...
              <div class="grid gap-y-2 my-2">
                <div class="flex w-full gap-x-1">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md p-2" onchange="unidadHvac(this.value,3,'cheTipo_2_3','{{App::getLocale()}}');check_chiller(this.value,'csStd_2_3',1);" name="cUnidad_2_3" id="cUnidad_2_3" >
                                <option value="0">{{ __('index.seleccionar') }}</option>
                                <option value="1">Paquetes (RTU)</option>
                                <option value="2">Split DX</option>
                                <option value="3">VRF No Ductados</option>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <label class="labels" for=""><b>{{ __('index.tipo equipo') }}</b> </label>
                         ...
                         <div class="w-full flex justify-start">
                        <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2" onchange="change_diseño(this.value,3,'cheDisenio_2_3','tipo_control_2_3','dr_2_3','lblCsTipo_2_3');"  name="cheTipo_2_3" id="cheTipo_2_3">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md py-2"  onchange="send_name(this.id);" name="cheDisenio_2_3" id="cheDisenio_2_3">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start gap-x-2">
                            <div class="w-full">
                                <input style="margin-left: 2.3px;" name="capacidad_total_2_3" id="capacidad_total_2_3" onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-2 text-center" >
                            </div>
                            <div class="w-full">
                                <input class="w-full h-full border-2 border-color-inps rounded-md py-2 text-center"  type="text" readonly name="unidad_capacidad_tot_2_3" id="unidad_capacidad_tot_2_3" >
                            </div>
                        </div>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                        ...
                        <div class="w-1/2 flex justify-start">
                        <input name="costo_elec_2_3" id="costo_elec_2_3" readonly onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full text-center border-2 border-color-inps rounded-md py-1">
                        </div>
                    </div>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex justify-start w-1/3">
                        <input type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center"  name="hrsEnfriado_2_3" id="hrsEnfriado_2_3" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                        <div class="flex justify-start w-1/3">
                            <select name="csStd_2_3" id="csStd_2_3" onchange="check_send_efi(this.value,document.getElementById('cUnidad_2_3').value,'csStd_2_3');" style="padding-top: 0.528rem;padding-bottom: 0.528rem;" class="w-full border-2 border-color-inps rounded-md text-center">

                            </select>
                        </div>
                        <div class="flex justify-start w-1/4">
                        <input  name="csStd_cant_2_3" id="csStd_cant_2_3" type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center">
                          </div>
                    </div>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex justify-start w-full">
                            <select class="w-full border-2 border-color-inps rounded-md py-1" onchange="send_name_t_c(this.id);"  name="tipo_control_2_3" id="tipo_control_2_3">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                        <select style="width: 77%;" class="border-2 border-color-inps rounded-md py-1" onchange="send_name_dr(this.id);" name="dr_2_3" id="dr_2_3" >
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select style="margin-left: 1px;" class="w-full border-2 border-color-inps rounded-md py-2" name="cheMantenimiento_2_3" id="cheMantenimiento_2_3">
                                <option value="0">{{ __('index.seleccionar') }}</option>
                                <option value="ASHRAE 180">ASHRAE 180</option>
                                <option value="Deficiente">Deficiente</option>
                                <option value="Sin Mantenimiento">Sin Mantenimiento</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                        ...
                        <div class="w-1/2 flex justify-start text-left">
                            <input onchange="format_num(this.value,this.id);"  class="2xl:w-full xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center" name="cheValorS_2_3" id="cheValorS_2_3" >
                        </div>
                    </div>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-full flex gap-x-2 justify-start">
                            <div class="flex">
                                <input type="text" onchange="format_num(this.value,this.id);" class="2xl:w-full xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center"  name="maintenance_cost_2_3" id="maintenance_cost_2_3" >
                            </div>
                            <div class="flex justify-end">
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                            ...
                            <option value="10">Chiller - Aire - Tornillo 4 Etapas</option> --}}
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        ,'costo_elec_3_1','cheStd_3_1','cheValorS_3_1','3_1','action_submit_3_1','csStd2_3_1','maintenance_cost_3_1','marca_3_1','modelo_3_1','ventilacion_3_1','filtracion_3_1','tipo_ambiente_3_1','proteccion_condensador_3_1','proteccion_condensador_3_1_value','_');
                                        }
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            <div class="flex justify-start w-1/2 text-left">
                             ...
                             <div class="w-full flex justify-start">
                                    <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2" onchange="change_diseño(this.value,1,'cheDisenio_3_1','tipo_control_3_1','dr_3_1','ventilacion_3_1','filtracion_3_1','lblCsTipo_3_1');"  name="cheTipo_3_1" id="cheTipo_3_1">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select name="marca_3_1" id="marca_3_1" class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_modelos(this.value,'modelo_3_1');send_marca_to_modal(this.value,'marca_3_1');">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex w-1/2 justify-start gap-x-2">
                                <div class="w-full">
                                    ...
                                    <input id="capacidad_total_3_1" name="capacidad_total_3_1" type="text" onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-2 text-center" >
                                    <input  id="capacidad_total_3_1_count" name="capacidad_total_3_1_count" type="number" class="hidden" value="1">

                                </div>
                                <div class="w-full">
                                    <input class="w-full  border-2 border-color-inps rounded-md h-full text-center"  type="text" readonly name="unidad_capacidad_tot_3_1" id="unidad_capacidad_tot_3_1" >
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start gap-x-2">
                                <div class="flex justify-start w-1/3">
                                    <select name="csStd2_3_1" id="csStd2_3_1" style="font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_3_1').value,'csStd2_3_1');" style="padding-top: 0.4rem;padding-bottom: 0.4rem;"{{--  onchange="set_ser_to_sers(this.value);" --}} class="w-full border-2 border-color-inps rounded-md text-center">

                                    </select>
                                </div>
                                <div class="flex justify-start w-1/3">
                                 <input  name="cheStd_3_1" id="cheStd_3_1" type="text"  style="font-size: 14px;" class="w-full py-1 border-2 border-color-inps rounded-md text-center">
                                </div>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex justify-start w-1/3">
                                <input type="text" style="font-size: 14px;" class="w-full py-1 border-2 border-color-inps rounded-md  text-center"  step="0.01" name="hrsEnfriado_3_1" id="hrsEnfriado_3_1" readonly>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2 gap-y-1">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="send_name(this.id);check_sin_doa(this.id,'ventilacion_3_1','filtracion_3_1','cheTipo_3_1');" name="cheDisenio_3_1" id="cheDisenio_3_1">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex justify-start w-full">
                                <select class="w-full border-2 border-color-inps rounded-md py-1"  onchange="send_name_t_c(this.id);"  name="tipo_control_3_1" id="tipo_control_3_1">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-3 w-1/2">
                            <div class="w-1/3 flex justify-start text-left">
                                <label style="font-size: 14px;" class="" for=""><b>{{ __('index.dr') }}</b> </label>
                            </div>
                            <div class="w-full flex justify-start">
                                <select  style="width: 77%;margin-left:2.5px;" class="border-2 border-color-inps rounded-md py-1" onchange="send_name_dr(this.id);" name="dr_3_1" id="dr_3_1" >
                                    <option value="">{{ __('index.seleccionar') }}</option>
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_3_1','cUnidad_3_1','cheTipo_3_1');"  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_3_1" id="ventilacion_3_1">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="cheMantenimiento_3_1" id="cheMantenimiento_3_1">
                                    <option value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="ASHRAE 180">ASHRAE 180</option>
                                    <option value="Deficiente">Deficiente</option>
                                    <option value="Sin Mantenimiento">Sin Mantenimiento</option>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_3_1','new',3,'paises_edit');"  style="width: 77%;margin-left:0px;" readonly class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_3_1" id="tipo_ambiente_3_1">
                                    <option selected value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="no_agresivo">No Agresivo</option>
                                    <option value="marino">Marino</option>
                                    <option value="contaminado">Contaminado</option>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2">
                            ...
                            <div class="w-1/2 flex justify-start">
                                 <input onchange="format_num(this.value,this.id);"  class="2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center" name="cheValorS_3_1" id="cheValorS_3_1" >
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                            ...
                            <option value="10">Chiller - Aire - Tornillo 4 Etapas</option> --}}
                                ...
                                $(document).ready(function () {
                                    ...
                                    ,'costo_elec_3_2','csStd_cant_3_2','cheValorS2_3_2','sol_3_2','action_submit_3_2','csStd_3_2','maintenance_cost_3_2','marca_3_2','modelo_3_2','ventilacion_3_2','filtracion_3_2','tipo_ambiente_3_2','proteccion_condensador_3_2','proteccion_condensador_3_2_value','_');
                                        }
                                });
                                </script>
                            </select>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                            <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2" onchange="change_diseño(this.value,2,'cheDisenio_3_2','tipo_control_3_2','dr_3_2','ventilacion_3_2','filtracion_3_2','lblCsTipo_3_2');" name="cheTipo_3_2" id="cheTipo_3_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select name="marca_3_2" id="marca_3_2" class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_modelos(this.value,'modelo_3_2');">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex w-1/2 justify-start gap-x-2">
                            <div class="w-full">
                                <input id="capacidad_total_3_2" name="capacidad_total_3_2" type="text" onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md h-full text-center" >
                            </div>
                            <div class="w-full">
                                <input class="w-full  border-2 border-color-inps rounded-md h-full text-center"  type="text" readonly name="unidad_capacidad_tot_3_2" id="unidad_capacidad_tot_3_2" >
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex justify-start w-1/3">
                            <select name="csStd_3_2" id="csStd_3_2" style="font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_3_2').value,'csStd_3_2');" style="padding-top: 0.528rem;padding-bottom: 0.528rem;"{{--  onchange="set_ser_to_sers(this.value);" --}} class="w-full border-2 border-color-inps rounded-md text-center">

                            </select>
                        </div>
                        <div class="flex justify-start w-1/3">
                            <input step="0.5" name="csStd_cant_3_2" id="csStd_cant_3_2" type="number" style="font-size: 14px;" class="w-full py-1 border-2 border-color-inps rounded-md  text-center">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <input name="costo_elec_3_2" id="costo_elec_3_2" readonly onkeypress="return soloNumeros(event)" type="text" style="font-size: 14px;" class="w-full text-center border-2 border-color-inps rounded-md py-1">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex justify-start w-1/3">
                            <input type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center" name="hrsEnfriado_3_2" id="hrsEnfriado_3_2" readonly>
                        </div>
                ...
                <div class="flex w-full 2xl:mt-4 xl:mt-4 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2 gap-y-1">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="send_name(this.id);check_sin_doa(this.id,'ventilacion_3_2','filtracion_3_1','cheTipo_3_2');" name="cheDisenio_3_2" id="cheDisenio_3_2">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex justify-start w-full">
                            <select class="w-full border-2 border-color-inps rounded-md py-1" onchange="send_name_t_c(this.id);" name="tipo_control_3_2" id="tipo_control_3_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-3 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                            <select  style="width: 77%;margin-left:2.5px;"  class="border-2 border-color-inps rounded-md py-1"  onchange="send_name_dr(this.id);" name="dr_3_2" id="dr_3_2" >
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_3_2','cUnidad_3_2','cheTipo_3_2');"  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_3_2" id="ventilacion_3_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="cheMantenimiento_3_2" id="cheMantenimiento_3_2">
                                <option value="">{{ __('index.seleccionar') }}</option>
                                <option value="ASHRAE 180">ASHRAE 180</option>
                                <option value="Deficiente">Deficiente</option>
                                <option value="Sin Mantenimiento">Sin Mantenimiento</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_3_2','new',3,'paises_edit');"  style="width: 77%;margin-left:0px;" readonly class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_3_2" id="tipo_ambiente_3_2">
                                <option selected value="0">{{ __('index.seleccionar') }}</option>
                                <option value="no_agresivo">No Agresivo</option>
                                <option value="marino">Marino</option>
                                <option value="contaminado">Contaminado</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2">
                        ...
                        <div class="w-1/2 flex justify-start">
                             <input onchange="format_num(this.value,this.id);"  class="2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center" name="cheValorS2_3_2" id="cheValorS2_3_2" >
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-full flex gap-x-2 justify-start">
                            <div class="flex">
                                <input type="text" onchange="format_num(this.value,this.id);" class="2xl:w-full xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-2 text-center"  name="maintenance_cost_3_2" id="maintenance_cost_3_2" >
                            </div>
                            <div class="flex justify-end">
              ...
              <div class="grid gap-y-2 my-2">
                <div class="flex w-full">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md p-2"  onchange="unidadHvac(this.value,1,'cheTipo_3_3','{{App::getLocale()}}');check_chiller(this.value,'csStd_3_3',1);" name="cUnidad_3_3" id="cUnidad_3_3" >
                                <option value="0">{{ __('index.seleccionar') }}</option>
                                <option value="1">Paquetes (RTU)</option>
                                <option value="2">Split DX</option>
                                <option value="3">VRF No Ductados</option>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                      ...
                      <div class="w-full flex justify-start">
                            <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2"  onchange="change_diseño(this.value,3,'cheDisenio_3_3','tipo_control_3_3','dr_3_3','lblCsTipo_3_3');" name="cheTipo_3_3" id="cheTipo_3_3">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md py-2"  onchange="send_name(this.id);" name="cheDisenio_3_3" id="cheDisenio_3_3">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start gap-x-2">
                        <div class="w-full">
                         <input name="capacidad_total_3_3" id="capacidad_total_3_3" type="text" onchange="format_nums_no_$(this.value,this.id);"  onkeypress="return soloNumeros(event)" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-2 text-center" >
                        </div>
                        <div class="w-full">
                            <input readonly  type="text" class="w-full border-2 border-color-inps rounded-md py-2 text-center" name="unidad_capacidad_tot_3_3" id="unidad_capacidad_tot_3_3" >
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2">
                        ...
                        <div class="w-1/2 flex justify-start">
                         <input name="costo_elec_3_3"  onkeypress="return soloNumeros(event)" readonly id="costo_elec_3_3" type="text" style="font-size: 14px;" class="w-full text-center border-2 border-color-inps rounded-md py-1">
                        </div>
                    </div>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex justify-start w-1/3">
                            <input type="text" style="font-size: 14px;" class="w-full border-2 border-color-inps rounded-md py-1 text-center" name="hrsEnfriado_3_3" id="hrsEnfriado_3_3" readonly>
                        </div>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2 gap-y-1">
                        <div class="flex justify-start w-1/3">
                            <select name="csStd_3_3" id="csStd_3_3" style="padding-top: 0.528rem;padding-bottom: 0.528rem;" class="w-full border-2 border-color-inps rounded-md text-center">

                            </select>
                        </div>
                        <div class="flex justify-start w-1/4">
                         <input name="cheStd_3_3" id="cheStd_3_3" type="text" style="font-size: 14px;" class="w-full py-1 border-2 border-color-inps rounded-md text-center">
                        </div>
                    </div>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex justify-start w-full">
                            <select class="w-full border-2 border-color-inps rounded-md py-1" onchange="send_name_t_c(this.id);"  name="tipo_control_3_3" id="tipo_control_3_3">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-3 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                            <select  style="width: 77%;margin-left:2.5px;" class="border-2 border-color-inps rounded-md py-1" onchange="send_name_dr(this.id);"  name="dr_3_3" id="dr_3_3" >
                            </select>
                        </div>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                                <select style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="cheMantenimiento_3_3" id="cheMantenimiento_3_3">
                                    <option value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="ASHRAE 180">ASHRAE 180</option>
                                    <option value="Deficiente">Deficiente</option>
                                    <option value="Sin Mantenimiento">Sin Mantenimiento</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <input onchange="format_num(this.value,this.id);"  class="2xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center" name="cheValorS_3_3" id="cheValorS_3_3" >
                        </div>
                    </div>
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-full flex gap-x-2 justify-start">
                            <div class="flex">
                                <input type="text" style="margin-left:1px ;" onchange="format_num(this.value,this.id);" class="2xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center"  name="maintenance_cost_3_3" id="maintenance_cost_3_3" >
                            </div>
                            <div class="flex justify-end">
