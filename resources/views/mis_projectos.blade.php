...
<div class="bg-transparent w-full flex justify-center" >
    <div class="w-1/3 flex h-full">
         <img class="pt-2" style="max-height: 100px; width:230px;margin-left:4.3rem;" name="logoEmpresa" id="logoEmpresa" src="{{asset('assets/images/Logotipo-HVACOPCOST.png')}}" alt="Nano Degree">
    </div>
    ...
    <div class="w-1/3 my-6 mr-2 flex justify-end h-1/3">
        ...
        <button  title="Inicio" class="bg-transparent mx-1 px-3 py-2 rounded-md hover:bg-blue-900  font-roboto action:bg-blue-600" onclick="window.location.href='home'"><i style="color:#0D08EE;" class="text-4xl fas fa-arrow-left mt-1"></i></button>
