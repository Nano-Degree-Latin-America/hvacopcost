        ...
        <div style="border-color:#233064;" class="border-r-2 border-l-2">
            ...
            <div class="grid w-full" id="sol_1_1" name="sol_1_1">
               ...
               <div class="flex w-full ">
                <div class="w-full  mt-2 mx-2 bg-white rounded-md shadow-md">
                  <div class="grid gap-y-1 my-2 ">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                            ...
                            <div class="flex justify-start w-1/4">
                                <select name="csStd_1_1_retro" id="csStd_1_1_retro" style="font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_1_1_retro').value,'csStd_1_1_retro');" style="padding-top: 0.43rem;padding-bottom: 0.43rem;" class="w-full border-2 border-color-inps rounded-md text-center">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select onchange="valida_selects_inps(this.id);send_name(this.id);check_type_set_mant('type_p','cheDisenio_2_1_retro','cheDisenio_3_1_retro',this.value);check_sin_doa(this.id,'ventilacion_1_1_retro','filtracion_1_1_retro','csTipo_1_1_retro');" name="csDisenio_1_1_retro" id="csDisenio_1_1_retro" class="w-full border-2 border-color-inps rounded-md py-2">
                                </select>
                            </div>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select style="width:100%;margin-right:5px;" class="border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_name_dr(this.id);check_type_set_mant('type_p','dr_2_1_retro','dr_3_1_retro',this.value);" name="dr_1_1_retro" id="dr_1_1_retro" >
                                </select>
                            </div>
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);check_ventilacion(this.id,'filtracion_1_1_retro','cUnidad_1_1_retro','csTipo_1_1_retro');"  style="" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_1_1_retro" id="ventilacion_1_1_retro">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2">
                            ...
                            <div class="flex w-1/2 justify-start">
                                <select onchange="valida_selects_inps(this.id);"  style="width: 100%;margin-left:2px;" class="border-2 border-color-inps rounded-md py-1" name="filtracion_1_1_retro" id="filtracion_1_1_retro">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_1_1_retro','retro','yrs_vida_1_1_retro','paises_edit');send_ambiente(this.value,'retro');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_1_1_retro" id="tipo_ambiente_1_1_retro">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <input type="text" style="margin-left: 0px;" onchange="valida_selects_inps(this.id);format_num(this.value,this.id);" class="2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center"  name="maintenance_cost_1_1_retro" id="maintenance_cost_1_1_retro" >
                            </div>
...
<div style="width: 100%" class="mx-1">
    {{-- 2.1 --}}
    <div style="background-color: #0D08EE;" class="text-white rounded-t-xl w-80 bg-orange-500  2xl:flex xl:flex lg:grid justify-between 2xl:py-3 xl:py-3 lg:py-0 ">
        <div class="ml-5 2xl:w-10 xl:w-auto lg:w-1/4 flex justify-start">
            <a href="#final2">
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex justify-start w-1/3 ml-2">
                        ...
                        <div class="flex justify-start w-1/3 mr-1">
...
{{--                          --}}
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_name(this.id);check_sin_doa(this.id,'ventilacion_2_1_retro','filtracion_2_1_retro','cheTipo_2_1_retro');" name="cheDisenio_2_1_retro" id="cheDisenio_2_1_retro">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                        <select  style="width: 100%;" class="border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_name_dr(this.id);" name="dr_2_1_retro" id="dr_2_1_retro" >
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);check_ventilacion(this.id,'filtracion_2_1_retro','cUnidad_2_1_retro','cheTipo_2_1_retro');"  style="" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_2_1_retro" id="ventilacion_2_1_retro">

                            </select>
                            <input  id="ventilacion_2_1_retro_count" name="ventilacion_2_1_retro_count" type="number" class="hidden" value="1">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2">
                        ...
                        <div class="flex w-1/2 justify-start">
                            <select onchange="valida_selects_inps(this.id);"  style="width: 100%;margin-left:4px;" class="border-2 border-color-inps rounded-md py-1" name="filtracion_2_1_retro" id="filtracion_2_1_retro">


                            </select>
                            <input  id="filtracion_2_1_retro_count" name="filtracion_2_1_retro_count" type="number" class="hidden" value="1">
 ...
 --}}
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_2_1_retro','retro','yrs_vida_2_1_retro','paises_edit');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_2_1_retro" id="tipo_ambiente_2_1_retro">
                                <option selected value="0">{{ __('index.seleccionar') }}</option>
                                <option value="no_agresivo">No Agresivo</option>
                                <option value="marino">Marino</option>
                                <option value="contaminado">Contaminado</option>
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
               ...
               <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                   ...
                   <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                       ...
                       <div class="w-full flex justify-start">
                           <select style="font-size: 14px" onchange="valida_selects_inps(this.id);send_efi_cant(this.value,'csStd_cant_3_1_retro')" class="w-full border-2 border-color-inps rounded-md py-2"   name="modelo_3_1_retro" id="modelo_3_1_retro">
                           </select>
                       </div>
...
--}}
               ...
               <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                   <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2 gap-y-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_name(this.id);check_sin_doa(this.id,'ventilacion_3_1_retro','filtracion_3_1_retro','cheTipo_3_1_retro');" name="cheDisenio_3_1_retro" id="cheDisenio_3_1_retro">
               ...
               <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);check_ventilacion(this.id,'filtracion_3_1_retro','cUnidad_3_1_retro','cheTipo_3_1_retro');"  style="" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_3_1_retro" id="ventilacion_3_1_retro">


                        </select>
                        <input  id="ventilacion_3_1_retro_count" name="ventilacion_3_1_retro_count" type="number" class="hidden" value="1">
               ...
               <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                   <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="filtracion_3_1_retro" id="filtracion_3_1_retro">
               ...
               <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_3_1_retro','retro','yrs_vida_3_1_retro','paises_edit');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_3_1_retro" id="tipo_ambiente_3_1_retro">
                            <option selected value="0">{{ __('index.seleccionar') }}</option>
                            <option value="no_agresivo">No Agresivo</option>
                            <option value="marino">Marino</option>
                            <option value="contaminado">Contaminado</option>
                   ...
                   <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    <div id="costo_anual_reparaciones_3_1_retro" name="costo_anual_reparaciones_3_1_retro" class="flex w-full  gap-x-1">
                        ...
                        <div class="w-1/2 flex justify-start text-left ml-3">
                            <input type="text"  onchange="format_num(this.value,this.id);valida_selects_inps(this.id)"  class="2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-color-inps rounded-md py-1 text-center" name="const_an_rep_3_1" id="const_an_rep_3_1" >
