 ...
 --}}
                            ...
                            <div class="ml-5 xl:ml-0 lg:ml-0 md:ml-0 lg:sm-0 ">
                                <div class="grid gap-y-3 type_proy_pos">
                                    ...
                                    <div class="flex">
                                        <input disabled class="check_style" id="man" type="checkbox" class="w-4 h-4 text-blue-800 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
