              ...
              <div style="width: 100%" class="flex justify-center">
                ...
                <form id="base_calculo_form" name="base_calculo_form" class="w-full flex space-x-3 justify-center">
                    ...
                    <div class="flex flex-col">
                      <label for="sistema" class="text-gray-700 font-bold font-roboto text-lg">Sistema</label>
                      <input readonly type="text" id="sistema" name="sistema" class="text-black 2xl:xl:w-full xl:w-full lg:w-3/6 border-2 border-blue-600 rounded-md py-2 text-center">
                    </div>
                   {{--  <div class="flex flex-col">
