        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li aria-current="page">
            <div class="flex items-center">
             ...
             <a href="#"> <span class="ml-1 font-montserrat  text-[22px] text-gray-400 md:ml-2 dark:text-gray-500">Sucursales</span></a>
...
<div class="w-full flex justify-start mt-5 mx-5">
    <label class="text-[24px] font-bold" style="color: #102E52">Crear Sucursal</label>
</div>

<form action="{{ route('sucursales.store') }}" id="formulario" method="POST">
    @csrf
    <div class="flex w-full justify-start mx-5">
        <div class="grid w-2/5 gap-x-4 border-2 border-blue-500 rounded-xl my-5">

            <div class="w-90 m-3">
                <input type="text" value="{{$id}}" style="display: none;" name="id_empresa" id="id_empresa">
                <div class="flex w-full gap-x-4">
                    <div class="w-1/2">
                        <div class="w-full flex">
                            <label class="text-[16px]" style="color: #102E52">Nombre<span class="text-red-500">*</span></label>
                        </div>
                        <input type="text" id="nombre" name="nombre"  type="text" placeholder="Ingrese nombre" class="w-full border-2 border-blue-500 rounded-md" >
                    </div>
                    ...
                    <div class="w-1/2">
                        ...
                        <input id="contacto" name="contacto" type="text" placeholder="Ingrese Contacto" class="w-full border-2 border-blue-500 rounded-md" >
                    </div>
                </div>
                ...
                <div class="flex w-full mt-3 gap-x-4">
                    <div class="w-full">
                        ...
                        <input  id="direccion" name="direccion"  type="text" placeholder="Ingrese dirección" class="w-full border-2 border-blue-500 rounded-md">
                    ...
                    <div class="w-1/3">
                        ...
                        <input id="telefono" name="telefono" maxlength="15" onkeypress="return soloNumeros(event)" type="number" placeholder="Ingrese número de teléfono" class="w-full border-2 border-blue-500 rounded-md">
                    </div>
                </div>
                ...
                <div class="flex w-full gap-x-4 mt-3">
                    <div class="w-1/2">
                        ...
                        <input id="ciudad" name="ciudad"  type="text" placeholder="Ingrese ciudad" class="w-full border-2 border-blue-500 rounded-md" >
                    </div>
                    ...
                    <div class="w-1/2">
                        ...
                        <input id="pais" name="pais" type="text"    placeholder="Ingrese País" class="w-full border-2 border-blue-500 rounded-md"  >
                    </div>
                ...
                <div class="flex w-full mt-3 gap-x-4">
                    <div class="w-1/2">
                        ...
                        <input id="email" name="email" type="email"  placeholder="Ingrese correo" class="w-full border-2 border-blue-500 rounded-md">
                    </div>
                    <div class="w-1/2">
                        <div class="w-full flex">
                            <label class="text-[16px]" style="color: #102E52">Código Postal<span class="text-red-500">*</span></label>
                        </div>
                        <input id="codigo_postal" name="codigo_postal"  maxlength="15" onkeypress="return soloNumeros(event)" type="number"  placeholder="Ingrese código postal" class="w-full border-2 border-blue-500 rounded-md">
                    </div>
                </div>
                ...
                <div class="flex w-full gap-x-4 mt-3">
                    ...
                    <div class="w-full">
                        ...
                        <textarea type="text" placeholder="Ingrese datos" class="w-full border-2 border-blue-500 rounded-md" id="numero_fiscal" name="numero_fiscal"></textarea>
