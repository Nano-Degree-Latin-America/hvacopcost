        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          <li class="inline-flex items-center">
            <a href="/empresas" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
              ...
              <p class="font-montserrat text-[#102E52] text-[25px]">Scursales</p>
...
<div class="w-full flex justify-start mt-5 mx-5">
    <label class="text-[24px] font-bold" style="color: #102E52">Editar Sucursal {{$sucursal->name}}</label>
</div>

<form action="{{url('/sucursales', [$sucursal->id])}}" id="formulario" method="POST">
    @csrf
            ...
            <div class="w-90 m-3">
                ...
                <div class="flex w-full gap-x-4">
                    <div class="w-1/2">
                        ...
                        <input type="text" id="nombre" name="nombre" value="{{$sucursal->name}}"  type="text" placeholder="Ingrese nombre" class="w-full border-2 border-blue-500 rounded-md" >
                    </div>
                    ...
                    <div class="w-1/2">
                        ...
                        <input id="telefono" name="telefono"  value="{{$sucursal->telefono}}" maxlength="15" onkeypress="return soloNumeros(event)" type="number" placeholder="Ingrese número de teléfono" class="w-full border-2 border-blue-500 rounded-md">
                    </div>
                </div>
                ...
                <div class="flex w-full mt-3 gap-x-4">
                    <div class="w-full">
                        ...
                        <input  id="direccion" name="direccion" value="{{$sucursal->direccion}}" type="text" placeholder="Ingrese dirección" class="w-full border-2 border-blue-500 rounded-md">
                    ...
                    <div class="w-1/3">
                        ...
                        <input id="ciudad" name="ciudad" value="{{$sucursal->ciudad}}"  type="text" placeholder="Ingrese ciudad" class="w-full border-2 border-blue-500 rounded-md" >
                    </div>
                </div>
                ...
                <div class="flex w-full mt-3 gap-x-4">
                    <div class="w-1/2">
                        ...
                        <input id="email" name="email" type="email" value="{{$sucursal->email}}" placeholder="Ingrese correo" class="w-full border-2 border-blue-500 rounded-md">
                    </div>
                    <div class="w-1/2">
                        <div class="w-full flex">
                            <label class="text-[16px]" style="color: #102E52">Código Postal<span class="text-red-500">*</span></label>
                        </div>
                        <input id="codigo_postal" name="codigo_postal" value="{{$sucursal->codigo_postal}}" maxlength="15" onkeypress="return soloNumeros(event)" type="number"  placeholder="Ingrese código postal" class="w-full border-2 border-blue-500 rounded-md">
                    </div>
                </div>
                ...
                <div class="flex w-full gap-x-4 mt-3">
                    ...
                    <div class="w-full">
                        ...
                        <textarea type="text" placeholder="Ingrese datos" value="{{$sucursal->numero_fiscal}}" class="w-full border-2 border-blue-500 rounded-md" id="numero_fiscal" name="numero_fiscal"></textarea>
