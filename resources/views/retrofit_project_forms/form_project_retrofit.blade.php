  ...
  {{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_1_1_retro','cUnidad_1_1_retro','csTipo_1_1_retro');"  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_1_1_retro" id="ventilacion_1_1_retro">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_1_1_retro','retro','yrs_vida_1_1_retro','paises');send_ambiente(this.value,'retro');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_1_1_retro" id="tipo_ambiente_1_1_retro">
    ...
    <div style="width: 100%" class="mx-1">
        {{-- 2.1 --}}
        <div style="background-color: #0D08EE;" class="text-white rounded-t-xl w-full bg-orange-500  2xl:flex xl:flex lg:grid justify-between 2xl:py-3 xl:py-3 lg:py-0 ">
            <div class="ml-5 2xl:w-10 xl:w-auto lg:w-1/4 flex justify-start">
                <a href="#final2">
...
{{--                              --}}
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_2_1_retro','cUnidad_2_1_retro','cheTipo_2_1_retro');"  style="" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_2_1_retro" id="ventilacion_2_1_retro">
...
--}}
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_3_1_retro','cUnidad_3_1_retro','cheTipo_3_1_retro');"  style="" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_3_1_retro" id="ventilacion_3_1_retro">
