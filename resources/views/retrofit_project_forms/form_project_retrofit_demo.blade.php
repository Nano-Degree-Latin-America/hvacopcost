<div id="" style=" display: flex; justify-content: center;" class="font-roboto">
    ...
    <div style="width: 100%" class="mx-1">
        {{-- 2.1 --}}
        <div style="background-color: #233064;" class="text-white rounded-t-xl w-full bg-orange-500  2xl:flex xl:flex lg:grid justify-between 2xl:py-3 xl:py-3 lg:py-0 ">
            <div class="ml-5 2xl:w-10 xl:w-auto lg:w-1/4 flex justify-start">
                <a href="#final2">
    ...
    <div style="width: 100%" class="mx-1">
         {{-- 3.1 --}}
         <div style="background-color: #233064;" class="text-white rounded-t-xl w-full 2xl:flex xl:flex lg:grid justify-between 2xl:py-3 xl:py-3 lg:py-0 ">
            <div class="ml-5 2xl:w-10 xl:w-auto lg:w-1/4 flex justify-start">
                <a href="#final3">
