...
<body>
   ...
   {{--  <header>
            ...
            <div>
                <div style="margin-right:5px;margin-top:5px;" class="column" >
                    <div class="sol_base" style="width:100%;">
                        <label style="margin-left:28px;" class="title_style">{{ __('index.sis_ext') }}</label>
                    </div>
                        ...
                        @if ($solution->num_enf == 1 && $solution->num_sol == 1  )
                            <div style="width:94%;">
                                ...
                                <div style="width:100%;" class="tarjet_anal_ene" style="margin-left: 5px;margin-top:15px;">
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.unidadhvac') }}</div>
                                ...
                                >
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.marca') }}</div>
                                ...
                                >
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.modelo') }}</div>
                                ...
                                >
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.yrs_life') }}</div>
                                ...
                                <div style="width:100%;" class="tarjet_anal_ene" style="margin-left: 5px;margin-top:15px;">
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.efi_ori') }}</div>
                                ...
                                <div style="width:100%;" class="tarjet_anal_ene" style="margin-left: 5px;margin-top:15px;">
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.val_dep') }}</div>
                                ...
                                <div style="width:100%;" class="tarjet_anal_ene" style="margin-left: 5px;margin-top:15px;;margin-bottom:30px;">
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.costo anual') }}</div>
                                ...
                                <div style="width:100%;" class="tarjet_anal_ene" style="margin-left: 5px;margin-top:15px;margin-bottom:30px;">
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.cost_an_re') }}</div>
                    ...
                    <div>
                        <div style="margin-right:5px;margin-top:5px;" class="column" >
                            ...
                            <div style="width:94%;">
                                ...
                                <div style="width:100%;" class="tarjet_anal_ene" style="margin-left: 5px;margin-top:15px;">
                                    <div>
                                        <div style="float: left; width: 50%;font-size:10px;--text-opacity: 1;color: #2a4365;font-weight: 700;">{{ __('index.efi') }}</div>
                                        <div style="float: right; width: 50%;font-size:10px;--text-opacity: 1;color: #3182ce;font-weight: 700;">{{$solution->eficencia_ene}} {{$solution->eficencia_ene_cant}}</div>
                                    </div>
                                </div>
                    ...
                    <tbody style="width: 100%;">
                        ...
                        <tr class="tr_style">
                            <td style="width: 100%;" class=""><label style="margin-left:20px;" class="title_cap_term" for="">{{ __('results.consumo_anual') }} (OPEX)</label></td>
                              ...
                              <td style="width: 100%;" class=""><label style="margin-left:40px;" class="cap_term" for="">{{number_format($sumaopex_2)}}</label>
    ...
    <div style="margin-top:5px; height:15%;" class="tarjet">
        ...
        <div style="margin-left:15px; margin-right:15px;">
            <div>
                ...
                <div style="margin-right:5px;margin-top:5px;" class="column_x_2" >
                    <div style="width:100%;">
                        <label style="margin-left:100px;" class="dif_sols_subtitle">{{ __('index.sis_ext') }} v/s A</label>
                    </div>
                    <div style="width:100%;">
                        @if ($dif_1 <= 0)
                ...
                <div style="margin-right:5px;margin-top:5px;" class="column_x_2" >
                    <div style="width:100%;">
                        <label style="margin-left:50px;" class="dif_sols_subtitle">{{ __('index.sis_ext') }} v/s B</label>
                    </div>
                    <div style="width:100%;">
                ...
                <div style="margin-right:5px;margin-top:5px;" class="column_x_2" >
                    ...
                    <div style="width:100%;">
                        @if ($dif_2 <= 0)
                        <label style="margin-left:90px;" class="cant_red">{{number_format($dif_2)}}</label>
                        @endif
...
<div style="margin-top:9px; height:11%;" class="tarjet">
    ...
    {{-- <div style="margin-top:5px; height:11%;" class="tarjet">
        <div align="center" class="title_tarjet_no_bg">
            <p  class="title_style_no_bg">{{ __('index.inversion inicial') }} (CAPEX) por Área<b style="color:#ed8936;">($/{{$uni_med1 = ($unidad_area == 'mc') ? 'm²' : 'ft²'}})</b></p>
        </div>
...
<div style="margin-top:5px; height:11%;" class="tarjet">
    <div align="center" class="title_tarjet_no_bg">
        <p  class="title_style_no_bg">{{ __('results.simple') }} ({{ __('results.ans') }})<b style="color:#ed8936;"></b></p>
    </div>
...
<div style="margin-top:5px; height:20%;" class="tarjet">
    ...
    <div style="margin-left:15px; margin-right:15px;">
        <table style="width: 100%">
            <tr>
            <th></th>
            <th class="yrs_style">1 {{ __('results.ans') }}</th>
            <th class="yrs_style">2 {{ __('results.ans') }}</th>
            <th class="yrs_style">3 {{ __('results.ans') }}</th>
            <th class="yrs_style">4 {{ __('results.ans') }}</th>
...
{{--      <img style="width:400px; height:300px;" src="https://quickchart.io/apex-charts/render?config={ chart: {type: 'bar',height: 350,stacked: true,stackType: 'normal',dropShadow: {enabled: true,enabledOnSeries: undefined,},toolbar: {show: false,},}, series: [{name: 'CAPEX',data: [{{$cap_op_3[2][0]}}, {{$cap_op_3[1][0]}}, {{$cap_op_3[0][0]}}]}, {name: 'OPEX',data: [{{$cap_op_3[2][1]}}, {{$cap_op_3[1][1]}}, {{$cap_op_3[0][1]}}]}], plotOptions: {bar: {horizontal: true,},}, xaxis: {categories: ['Solución B', 'Solución A', 'Solución Base'],labels: {style: {colors: [],fontSize: '14px',fontFamily: 'ABeeZee, sans-serif',fontWeight: 'bold',cssClass: 'apexcharts-yaxis-label',},},}, yaxis: { labels: {style: {colors: [],fontSize: '16px',fontFamily: 'ABeeZee, sans-serif',fontWeight: 'bold',cssClass: 'apexcharts-yaxis-label',},},},legend: {position: 'top',horizontalAlign: 'left',offsetX: 40,fontSize: '14px',fontFamily: 'ABeeZee, sans-serif',fontWeight: 'bold',markers: {width: 12,height: 12,strokeWidth: 0,radius: 12,customHTML: undefined,onClick: undefined,offsetX: 0,offsetY: 0,},},fill: {opacity: 1},        title: {text: '5 Años',align: 'center',offsetY:25,style: {fontSize: '24px',fontFamily: 'ABeeZee, sans-serif',fontWeight: 'bold',cssClass: 'apexcharts-yaxis-label',},}, }">
 --}}     {{-- Ahorro Anual Energía – Diferencia entre Soluciones (Kw/hr año) --}}
   {{--  <div style="margin-top:5px; height:20%;" class="tarjet">
    ...
    {{-- <div style="page-break-after:always;"></div> --}}
    <div  style="margin-top:6px; height:20%;" class="tarjet">
        <div align="center" class="title_tarjet_blue">
        ...
        <div style="margin-left:15px; margin-right:15px;">
            <table style="width: 100%">
                ...
                <tr>
                    <td class="sol_ab_yrs_style">{{ __('index.sis_ext') }}</td>
    ...
    <div style="margin-left:15px; margin-right:15px;">
        <table style="width: 100%">
            ...
            <?php  $red_en_mw_a_5=$smasolutions->red_en_mw(5,$dif_1) ?>
                @if ($red_en_mw_a_5 <= 0)
                <td class="porcent_analis_sus_yrs_style_red">{{number_format($red_en_mw_a_5)}}</td>
                @endif

                @if ($red_en_mw_a_5 > 0)
                <td class="porcent_analis_sus_yrs_style">{{number_format($red_en_mw_a_5)}}</td>
                @endif
            @endif
            ...
            <tr>
                ...
                @endif
                 ...
                 <?php  $red_en_mw_b_5=$smasolutions->red_en_mw(5,$dif_2) ?>
                    @if ($red_en_mw_b_5 <= 0)
                    <td class="porcent_analis_sus_yrs_style_red">{{number_format($red_en_mw_b_5)}}</td>
                    @endif

                    @if ($red_en_mw_b_5 > 0)
                    <td class="porcent_analis_sus_yrs_style">{{number_format($red_en_mw_b_5)}}</td>
                    @endif
                 @endif
                 @if ($result3 === null)
                 <td class="porcent_analis_sus_yrs_style">N/A</td>
    ...
    <div style="margin-left:15px; margin-right:15px;">
        <table style="width: 100%">
            ...
            <?php  $red_hu_carb_a_5=$smasolutions->red_hu_carb(5,$dif_1) ?>
                ...
                <td class="porcent_analis_sus_yrs_style_red">{{number_format($red_hu_carb_a_5)}}</td>
                @endif

                @if ($red_hu_carb_a_5 > 0)
                <td class="porcent_analis_sus_yrs_style">{{number_format($red_hu_carb_a_5)}}</td>
                @endif
            @endif
            @if ($result2 === null)
            <td class="porcent_analis_sus_yrs_style">N/A</td>
                ...
                @if ($result3 !== null)
                 ...
                 @if ($result3 !== null)
                  ...
                  <?php  $red_hu_carb_b_5=$smasolutions->red_hu_carb(5,$dif_2) ?>
                    ...
                    <td class="porcent_analis_sus_yrs_style_red">{{number_format($red_hu_carb_b_5)}}</td>
                    @endif

                    @if ($red_hu_carb_b_5 > 0)
                    <td class="porcent_analis_sus_yrs_style">{{number_format($red_hu_carb_b_5)}}</td>
                    @endif
                  @endif
    ...
    <div style="margin-left:15px; margin-right:15px;">
        <table style="width: 100%">
            ...
            <?php  $red_bol_ba_a_5=$smasolutions->red_bol_ba(5,$dif_1) ?>
                @if ($red_bol_ba_a_5 <= 0)
                <td class="porcent_analis_sus_yrs_style_red">{{number_format($red_bol_ba_a_5)}}</td>
                @endif

                @if ($red_bol_ba_a_5 > 0)
                <td class="porcent_analis_sus_yrs_style">{{number_format($red_bol_ba_a_5)}}</td>
                @endif
            @endif
            @if ($result2 === null)
            <td class="porcent_analis_sus_yrs_style">N/A</td>
            ...
            <tr>
                ...
                <td class="porcent_analis_sus_yrs_style">N/A</td>
                 ...
                 <?php  $red_bol_ba_b_5=$smasolutions->red_bol_ba(5,$dif_2) ?>
                    @if ($red_bol_ba_b_5 <= 0)
                    <td class="porcent_analis_sus_yrs_style_red">{{number_format($red_bol_ba_b_5)}}</td>
                    @endif

                    @if ($red_bol_ba_b_5 > 0)
                    <td class="porcent_analis_sus_yrs_style">{{number_format($red_bol_ba_b_5)}}</td>
                    @endif
                 @endif
                 @if ($result3 === null)
                 <td class="porcent_analis_sus_yrs_style">N/A</td>
...
<div class="tarjet">
    <div align="center" class="title_tarjet">
        <label  class="title_style">{{ __('results.ans_conf_prod') }}</label>
    </div>
...
<div  style="margin-top:6px; height:25%;" class="tarjet">
    ...
    <div style="margin-left:15px; margin-right:15px;margin-bottom:10px;">
        <table style="width: 100%; margin-top:20px;">
            <tr style="">
            <th class="sol_ab_yrs_style_confort" style="width:170px;">{{ __('index.sis_ext') }}</th>
            ...
            <tr>
                <th class="sol_ab_yrs_style_confort" style="width:170px;">{{ __('index.solucion') }} A</th>
            ...
            <tr>
                <td class="sol_ab_yrs_style_confort" style="width:170px;">{{ __('index.solucion') }} B</td>
