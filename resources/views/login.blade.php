                ...
                <div class="w-full flex justify-center">
                    <div  style="width: 390px;">
                        ...
                        <div class="container-login100-form-btn p-t-10">
                            <input type="button" onclick="window.location.href='/register'" class="login100-form-btn" style="" value="Registro">
                        </div>
                        <div class="container-login100-form-btn p-t-10">
                            <input type="button" onclick="window.location.href='/login'" class="login100-form-btn" style="" value="Entrar">
                        </div>
