<div id="modal_coolinghours" name="modal_coolinghours" class="fixed z-10 inset-0 overflow-y-auto mt-10 hidden">
      ...
      <div class="border-2 border-blue-600 inline-block align-bottom bg-white rounded_modal_ebergy_hvac text-left overflow-hidden shadow-xl transform transition-all w-1/5" style="margin-top:370px;margin-right:380px;" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
        ...
        <div class="bg-gray-50 px-4 pt-2 pb-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
            <button type="button" class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-blue-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue transition ease-in-out duration-150 sm:text-sm sm:leading-5" onclick="ocultar_modal('modal_coolinghours')">
              Cerrar
            </button>
          </span>
        </div>
