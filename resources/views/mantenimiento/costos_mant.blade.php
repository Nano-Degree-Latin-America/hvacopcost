    ...
    <div class="w-full flex gap-x-3  h-full">
        ...
        <div class="w-1/3 grid justify-items-center gap-y-1  h-auto self-start">
            ...
            <div style="width: 65%;" class="gap-x-3 flex mt-1 justify-center">
                ...
                <div class="w-1/4 flex justify-start">
                    <input type="text" class="w-full bg-blue-800 text-white border-2 border-color-inps text-lg rounded-md py-2 text-center">
                </div>
            </div>
            ...
            <div style="width: 65%;" class="gap-x-3 flex mt-1 justify-center">
                ...
                <div class="w-1/4 flex justify-start">
                    <input type="text" class="w-full text_blue border-2 border-color-inps text-lg rounded-md py-1 text-center">
                </div>
            </div>
