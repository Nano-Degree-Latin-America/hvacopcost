...
<div class="col-6 mx-2 xl:ml-0 lg:ml-0 md:ml-0 lg:sm-0 ">
...
<div style="width:220px;" class="col-6 ml-5 xl:ml-0 lg:ml-0 md:ml-0 lg:sm-0 bg-green-200" style="height:100%;">
    <img style="width:220px;height:750px;" src="{{asset('assets\images\banner_hor.png')}}" alt="">
