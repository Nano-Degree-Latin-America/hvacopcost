<div id="" style=" display: flex; justify-content: center;" class="font-roboto mt-8">
            ...
            <div class="flex w-full">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2 ">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select name="cUnidad_1_1" id="cUnidad_1_1" class="w-full border-2 rounded-md py-2 border-color-inps" onchange="valida_form_calc(1);unidadHvac(this.value,1,'csTipo',{{$module_1}});check_chiller(this.value,'csStd',1);send_value_equipo_marcas(this.id,this.value,'marca_1_1');">
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="w-full flex justify-start">
                        <select style="font-size: 14px" onchange="valida_selects_inps(this.id);check_type_set_mant('type_p','modelo_2_1','modelo_3_1',this.value);send_efi(this.value,'csStd','csStd_cant_1_1');" class="w-full border-2 border-color-inps rounded-md py-2"   name="modelo_1_1" id="modelo_1_1">
                        </select>
                    </div>
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="flex w-full justify-start gap-x-2">
                        <div class="flex justify-start w-full">
                            <select name="csStd" id="csStd" style="padding-top: 0.43rem;padding-bottom: 0.43rem;font-size: 14px;" onchange="check_send_efi(this.value,document.getElementById('cUnidad_1_1').value,'csStd','csStd_cant_1_1');" class="w-full border-2 border-color-inps rounded-md text-center">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select name="csDisenio_1_1" id="csDisenio_1_1" onchange="valida_selects_inps(this.id);send_name(this.id);check_sin_doa(this.id,'ventilacion_1_1','filtracion_1_1','csTipo');"  class="w-full border-2 border-color-inps rounded-md py-2">
                        </select>
                    </div>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_1_1','new',3,'paises');send_ambiente(this.value,'new');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_1_1" id="tipo_ambiente_1_1">
                            <option selected value="0">{{ __('index.seleccionar') }}</option>
      ...
      <div class="grid w-full hidden mb-1"  id="sol_1_2" name="sol_1_2">
       <div class="mx-2">
        ...
        <div class="flex">
        <div class="rounded-xl mt-3 shadow-md mx-2">
          ...
          <div class="grid gap-y-1 my-2">
            <div class="flex w-full">
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select  class="w-full border-2 border-color-inps rounded-md p-2" onchange="unidadHvac(this.value,2,'csTipo_1_2',{{$module_1}});check_chiller(this.value,'csStd_1_2',1);send_value_equipo_marcas(this.id,this.value,'marca_1_2');" name="cUnidad_1_2" id="cUnidad_1_2" >
                            <option value="0">{{ __('index.seleccionar') }}</option>
                            <option value="1">Paquetes (RTU)</option>
                            <option value="2">Split DX</option>
                            <option value="3">VRF No Ductados</option>
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                ...
                <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                    ...
                    <div class="w-full flex justify-start">
                        <select style="font-size: 14px" onchange="valida_selects_inps(this.id);check_enfi_mod(this.value,'csStd_1_2',this.id,'cUnidad_1_1');send_efi_cant(this.value,'csStd_cant_1_2')" class="w-full border-2 border-color-inps rounded-md py-2"   name="modelo_1_2" id="modelo_1_2">
                        </select>
                    </div>
       ...
       {{--  --}}
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                    ...
                    <div class="w-1/2 flex justify-start">
                        <select  class="w-full border-2 border-color-inps rounded-md py-2"  onchange="valida_selects_inps(this.id);send_name(this.id);check_sin_doa(this.id,'ventilacion_1_2','filtracion_1_2','csTipo_1_2');" name="csDisenio_1_2" id="csDisenio_1_2">
                        </select>
                    </div>
          ...
          {{--            --}}
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);send_name_vent(this.id);check_ventilacion(this.id,'filtracion_1_2','cUnidad_1_2','csTipo_1_2');"  style="margin-left: 2px;" class="w-full border-2 border-color-inps rounded-md py-2" name="ventilacion_1_2" id="ventilacion_1_2">
            ...
            <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                    ...
                    <div class="flex w-full justify-start">
                        <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_1_2','new',3,'paises');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_1_2" id="tipo_ambiente_1_2">
                            <option selected value="0">{{ __('index.seleccionar') }}</option>
                            <option value="no_agresivo">No Agresivo</option>
                            <option value="marino">Marino</option>
                            <option value="contaminado">Contaminado</option>
                  ...
                  <div class="grid gap-y-1 my-2">
                    <div class="flex w-full gap-x-1">
                        <div class="lg:grid 2xl:flex xl:flex  gap-x-1 w-1/2">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select class="w-full border-2 border-color-inps rounded-md p-2" onchange="unidadHvac(this.value,1,'cheTipo_2_1',{{$module_1}});check_chiller(this.value,'csStd_2_1',1);send_value_equipo_marcas(this.id,this.value,'marca_2_1');"  name="cUnidad_2_1" id="cUnidad_2_1" >
                                    <option value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="1">Paquetes (RTU)</option>
                                    <option value="2">Split DX</option>
                                    <option value="3">VRF No Ductados</option>
       ...
       {{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);check_sin_doa(this.id,'ventilacion_2_1','filtracion_2_1','cheTipo_2_1');send_name(this.id);" name="cheDisenio_2_1" id="cheDisenio_2_1">
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="flex w-full justify-start">
                                <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_2_1','new',3,'paises');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_2_1" id="tipo_ambiente_2_1">
                                    <option selected value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="no_agresivo">No Agresivo</option>
                                    <option value="marino">Marino</option>
                                    <option value="contaminado">Contaminado</option>
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                            <select style="font-size: 14px" class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);check_enfi_mod(this.value,'csStd_2_2',this.id,'cUnidad_2_1');send_efi_cant(this.value,'csStd_cant_2_2')"  name="modelo_2_2" id="modelo_2_2">
                            </select>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-1 gap-y-1">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md py-2"  onchange="valida_selects_inps(this.id);send_name(this.id);check_sin_doa(this.id,'ventilacion_2_2','filtracion_2_2','cheTipo_2_2');" name="cheDisenio_2_2" id="cheDisenio_2_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_2_2','new',3,'paises');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_2_2" id="tipo_ambiente_2_2">
                                <option selected value="0">{{ __('index.seleccionar') }}</option>
                                <option value="no_agresivo">No Agresivo</option>
                                <option value="marino">Marino</option>
                                <option value="contaminado">Contaminado</option>
                  ...
                  <div class="grid gap-y-1 my-2">
                    <div class="flex w-full">
                        <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select class="w-full border-2 border-color-inps rounded-md p-2"  onchange="unidadHvac(this.value,1,'cheTipo_3_1',{{$module_1}});check_chiller(this.value,'csStd2_3_1',1);send_value_equipo_marcas(this.id,this.value,'marca_3_1');" name="cUnidad_3_1" id="cUnidad_3_1" >
                                    <option value="0">{{ __('index.seleccionar') }}</option>
                                    <option value="1">Paquetes (RTU)</option>
                                    <option value="2">Split DX</option>
                                    <option value="3">VRF No Ductados</option>
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        ...
                        <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                            ...
                            <div class="w-full flex justify-start">
                                <select style="font-size: 14px" onchange="valida_selects_inps(this.id);check_enfi_mod(this.value,'csStd2_3_1',this.id,'cUnidad_2_1');send_efi_cant(this.value,'cheStd_3_1')" class="w-full border-2 border-color-inps rounded-md py-2"   name="modelo_3_1" id="modelo_3_1">
                                </select>
                            </div>
...
--}}
                    ...
                    <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                        <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2 gap-y-1">
                            ...
                            <div class="w-1/2 flex justify-start">
                                <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_name(this.id);check_sin_doa(this.id,'ventilacion_3_1','filtracion_3_1','cheTipo_3_1');" name="cheDisenio_3_1" id="cheDisenio_3_1">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_3_1','new',3,'paises');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_3_1" id="tipo_ambiente_3_1">
                                <option selected value="0">{{ __('index.seleccionar') }}</option>
                                <option value="no_agresivo">No Agresivo</option>
                                <option value="marino">Marino</option>
                                <option value="contaminado">Contaminado</option>
              ...
              <div class="grid gap-y-1 my-2">
                <div class="flex w-full">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md p-2" onchange="unidadHvac(this.value,1,'cheTipo_3_2',{{$module_1}});check_chiller(this.value,'csStd_3_2',1);send_value_equipo_marcas(this.id,this.value,'marca_3_2');" name="cUnidad_3_2" id="cUnidad_3_2" >
                                <option value="0">{{ __('index.seleccionar') }}</option>
                                <option value="1">Paquetes (RTU)</option>
                                <option value="2">Split DX</option>
                                <option value="3">VRF No Ductados</option>
...
{{--                             <option value="8">Chiller - Aire - Scroll Constante</option>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    ...
                    <div class="lg:grid 2xl:flex xl:flex gap-x-1 w-1/2">
                        ...
                        <div class="w-full flex justify-start">
                            <select style="font-size: 14px" onchange="valida_selects_inps(this.id);check_enfi_mod(this.value,'csStd_3_2',this.id,'cUnidad_3_1');send_efi_cant(this.value,'csStd_cant_3_2')" class="w-full border-2 border-color-inps rounded-md py-2"   name="modelo_3_2" id="modelo_3_2">
                            </select>
                        </div>
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex w-1/2 gap-x-2 gap-y-1">
                        ...
                        <div class="w-1/2 flex justify-start">
                            <select class="w-full border-2 border-color-inps rounded-md py-2" onchange="valida_selects_inps(this.id);send_name(this.id);check_sin_doa(this.id,'ventilacion_3_2','filtracion_3_1','cheTipo_3_2');" name="cheDisenio_3_2" id="cheDisenio_3_2">
                ...
                <div class="flex w-full 2xl:mt-3 xl:mt-3 lg:mt-0">
                    <div class="lg:grid 2xl:flex xl:flex gap-x-2 w-1/2">
                        ...
                        <div class="flex w-full justify-start">
                            <select onchange="valida_selects_inps(this.id);show_prot_cond(this.value,'proteccion_condensador_3_2','new',3,'paises');"  style="width: 77%;margin-left:0px;" class="border-2 border-color-inps rounded-md py-1" name="tipo_ambiente_3_2" id="tipo_ambiente_3_2">
                                <option selected value="0">{{ __('index.seleccionar') }}</option>
                                <option value="no_agresivo">No Agresivo</option>
                                <option value="marino">Marino</option>
                                <option value="contaminado">Contaminado</option>
