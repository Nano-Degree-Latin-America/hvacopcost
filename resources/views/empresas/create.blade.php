...
<div class="w-full flex justify-start mt-5 mx-5">
    <label class="text-[24px] font-bold" style="color: #102E52">Crear Empresa</label>
</div>

<form action="{{ route('empresas.store') }}" id="formulario" method="POST">
    @csrf
            ...
            <div class="w-90 m-3">
                ...
                <div class="flex w-full gap-x-4 mt-3">
                    ...
                    <div class="w-full">
                        ...
                        <textarea type="text" placeholder="Ingrese datos" class="w-full border-2 border-blue-500 rounded-md" id="datos_factura" name="datos_factura"></textarea>
