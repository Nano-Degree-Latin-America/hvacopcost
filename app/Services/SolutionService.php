...
class SolutionService
{
    ...
    public function new_project_save(Request $request,$id_project){
        ...
        if ($enfriamiento1 !== 0) {
            ...
            if ($sol_1_2 !== 0) {
                $sal_an_prom_aux = SolutionService::update_solution_1_2($request,$id_project,$action_submit_send);
            }
      ...
      if ($enfriamiento2 !== 0) {
          ...
          if ($sol_2_1 !== 0) {
                $sal_an_prom_aux = SolutionService::update_solution_2_1($request,$id_project,$action_submit_send);
          }

          if ($sol_2_2 !== 0) {
                $sal_an_prom_aux = SolutionService::update_solution_2_2($request,$id_project,$action_submit_send);
          }
      ...
      if ($enfriamiento3 !== 0) {
            ...
            if ($sol_3_1 !== 0){
                    $sal_an_prom_aux = SolutionService::update_solution_3_1($request,$id_project,$action_submit_send);
            }

            if ($sol_3_2 !== 0) {
                $sal_an_prom_aux = SolutionService::update_solution_3_2($request,$id_project,$action_submit_send);
            }
...
$solution_enf1->confort = $nivel_confotr_1_1;
    ...
    public function update_solution_1_2(Request $request,$id_project,$action_submit_send){
        ...
        if($request->has('action_submit_1_2')){
...
public function update_solution_2_1(Request $request,$id_project,$action_submit_send){
    ...
    if($request->has('action_submit_2_1')){
   ...
   if ($solution_enf2_1->unid_med == 'TR') {
    ...
    public function update_solution_2_2(Request $request,$id_project,$action_submit_send){
        ...
        if($request->has('action_submit_2_2')){
...
public function update_solution_3_1(Request $request,$id_project,$action_submit_send){
    ...
    if($request->has('action_submit_3_1')){
   ...
   /*  public function save_solution_3_1(Request $request,$id_project){
    ...
    public function update_solution_3_2(Request $request,$id_project,$action_submit_send){
                ...
                if($request->has('action_submit_3_2')){
